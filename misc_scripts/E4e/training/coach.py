...
from e4e_utils import common, train_utils
...
class Coach:
    ...
    def calc_loss(self, x, y, y_hat, latent):
        ...
        if self.is_training_discriminator():  # Adversarial loss
            ...
            if self.is_progressive_training():
                ...
                if hasattr(self.net.decoder, 'n_latent'):
                    dims_to_discriminate = getattr(self.net.decoder, 'n_latent')
                else:
                    dims_to_discriminate = [0]
    ...
    def forward(self, batch):
        ...
        y_hat, latent = self.net.forward(x, return_latent=True)
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Discriminator ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
    ...
    def sample_real_and_fake_latents(self, x):
        ...
        real_w = self.net.decoder.mapping(sample_z)
